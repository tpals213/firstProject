...
@Component("filedown")	// 설정 파일에 자동 등록 처리 됨(servlet-context.xml)
public class FileDownloadView extends AbstractView {
	// 파일 다운로드 처리용 뷰 클래스임
	// 스프링에서는 뷰리졸버에 의해 자동 연결 실행될 뷰클래스를 만들 때,
	// 스프링이 제공하는 AbstractView 를 상속 받아서 만들도록 정해 두었음 (반드시)
	...
	protected void renderMergedOutputModel(
		...
		// 파일 다운로드 처리용 코드 작성함
		// 컨트롤러 메소드에서 리턴해서 전송한 Model 의 값(File 객체)을 추출해서,
		...
		// 한글 파일명은 다운되는 클라이언트 컴퓨터의 os  문자셋과 맞추기함 -> 윈도우
